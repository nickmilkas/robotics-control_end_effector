...
def scenario_1():
    ...
    q_target1 = np.array([0.1 + np.pi / 2, 1.5, 1.4 + np.pi / 4, -1.8, 0.1, 3.6 - np.pi / 3, 0.1 + np.pi / 2])
...
def scenario_2():
    ...
    q_target2 = np.array([0.0, -0.785398, 0.0, -2.356194, 0.0, 1.570796 + 0.785398, 0.785398 + 0.785398 + np.pi / 2])
    return q_start2, q_target2


def scenario_3():
    q_start3 = np.array([1.0, -2.0, 1.0, -2.0, 1.0, -2.0, 1.0])
    q_target3 = np.array([2.0, -3.0, 2.0, -3.0, 2.0, -3.0, 2.0])
